{
    $Id: sysutils.pp,v 1.1.2.10 2003/06/06 23:24:35 hajny Exp $
...
{
    $Log: sysutils.pp,v $
    Revision 1.1.2.10  2003/06/06 23:24:35  hajny
      * fix for bug 2518 merged

    Revision 1.1.2.9  2002/10/29 21:50:52  michael
    + Added AddTerminateProc

    Revision 1.1.2.8  2002/10/22 22:36:30  michael
    + Added missing directoryexists function

    Revision 1.1.2.7  2002/01/22 07:41:11  michael
    + Fixed FileSearch bug in Win32 and made FIleSearch platform independent

    Revision 1.1.2.6  2002/01/19 11:47:10  peter
      * fixed fileread/filewrite

    Revision 1.1.2.5  2001/06/03 15:23:33  peter
      * outofmemory and invalidpointer exceptions fixed

    Revision 1.1.2.4  2001/02/20 22:24:55  pierre
     + support for long envs in GetEnvironmentVariable

    Revision 1.1.2.3  2001/02/20 21:18:09  michael

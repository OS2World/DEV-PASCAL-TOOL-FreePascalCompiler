{
    $Id: dpmiexcp.pp,v 1.1.2.11 2002/11/08 13:45:00 pierre Exp $
...
{$ifndef IN_SYSTEM}
{$GOTO ON}
{ all declarations of this unit must be integrated into
  a single object file otherwise you get problems with linking to C code }
{$smartlink off}
...
{
  $Log: dpmiexcp.pp,v $
  Revision 1.1.2.11  2002/11/08 13:45:00  pierre
   * interface CRC change totally removed

  Revision 1.1.2.10  2002/11/08 10:58:41  pierre
   * avoid an interface CRC change

  Revision 1.1.2.9  2002/02/06 23:58:36  pierre
   * correct saving of edi register

  Revision 1.1.2.8  2002/01/30 15:00:35  pierre
    + __maybe_fix_w2k_ntvdm_bug, adapted from DJGPP code.
    * don't try to call get_pm_exception_handler if _os_trueversion is $532
      because windows 2000 does not even set carry flag to report
      unsupported DPMI function.

  Revision 1.1.2.7  2002/01/24 12:51:06  pierre
   * __djgpp_exception_setup must be public

  Revision 1.1.2.6  2001/11/14 23:27:56  pierre
   * declare FPC_setjmp as public

  Revision 1.1.2.5  2001/06/15 22:12:40  pierre
   * exception 18 and 19 handling disabled as they crash GDB

  Revision 1.1.2.4  2001/06/11 12:40:36  pierre
   * missing selector for exceptions 18 and 19 added

  Revision 1.1.2.3  2001/06/06 11:07:41  pierre

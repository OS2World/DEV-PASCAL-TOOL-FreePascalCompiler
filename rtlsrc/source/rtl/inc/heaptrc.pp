{
    $Id: heaptrc.pp,v 1.1.2.15 2002/12/26 10:46:54 peter Exp $
...
{
  $Log: heaptrc.pp,v $
  Revision 1.1.2.15  2002/12/26 10:46:54  peter
    * set p to nil when 0 is passed to reallocmem

  Revision 1.1.2.14  2002/11/08 08:22:52  pierre
   * only claim if exact_info_size is changed

  Revision 1.1.2.13  2002/11/07 18:06:05  pierre
   * added EXTRA_CHAIN conditional, dispaly correct pointer value

  Revision 1.1.2.12  2002/11/05 13:04:32  pierre
   * win32 implementation fixed

  Revision 1.1.2.11  2002/10/31 07:02:58  pierre
    + ExtraInfoStringTypedefined to allow
      custom use of extrainfo record.

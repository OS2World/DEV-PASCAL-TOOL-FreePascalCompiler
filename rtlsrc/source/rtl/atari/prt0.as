...
|
	...
	movel  a4@(p_env),U_SYSATARI__ENV  | save environment pointer
|
...
|	addql  #6,sp
   	moveb  d0,U_SYSATARI_ARGLENGTH | save length
   	movel  a0,U_SYSATARI_ARGS     | save pointer to string
|
...
|
| ASSUME 16K STACK FOR THE MOMENT.
...
shrink:
	...
	addl   #12,sp
|
| call pascal entry point function _main()
|

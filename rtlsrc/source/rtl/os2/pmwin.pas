{****************************************************************************
    ...
    $Id: pmwin.pas,v 1.1.2.4 2002/11/11 20:55:32 hajny Exp $
...
{
  $Log: pmwin.pas,v $
  Revision 1.1.2.4  2002/11/11 20:55:32  hajny
    * WinCreateWindow correction + overloaded variant added

  Revision 1.1.2.3  2002/10/05 19:13:52  hajny
    * PMERR constants made available from outside

  Revision 1.1.2.2  2001/05/15 18:40:21  carl

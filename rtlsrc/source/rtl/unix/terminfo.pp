{
    $Id: terminfo.pp,v 1.2.2.3 2003/02/09 23:07:46 marco Exp $
...
{$ifdef OpenBSD}
function setuptermC(Term: PChar; fd: Longint; var ErrCode: Longint): Longint; cdecl; external name '_setupterm';
{$else}
...
{$ifdef OpenBSD}
function del_curtermC(term: TerminalCommon_ptr1): Longint; cdecl; external name '_del_curterm';
{$else}
...
{
  $Log: terminfo.pp,v $
  Revision 1.2.2.3  2003/02/09 23:07:46  marco
   * openbsd fixes

{
    $Id: crt.pp,v 1.1.2.8 2002/10/11 18:03:40 michael Exp $
...
{
  $Log: crt.pp,v $
  Revision 1.1.2.8  2002/10/11 18:03:40  michael
  + Fixed some small errors, based on suggestions by antal

  Revision 1.1.2.7  2002/05/31 11:18:21  marco
   * Rename fest for 1.0.x step one. Compiler and RTL

  Revision 1.1.2.6  2001/12/13 18:51:40  michael
  + Applied patch for arrow keys on french keyboards,
    patch by Jean-Pierre vial. (bugrep 1556)

  Revision 1.1.2.5  2001/07/30 21:54:05  peter
    * reset winminx,winminy to 1

  Revision 1.1.2.4  2001/06/27 20:21:47  peter
    * support large screens

  Revision 1.1.2.3  2001/03/21 16:01:07  jonas

{
    $Id: posix.pp,v 1.1.2.2 2001/12/20 03:04:15 carl Exp $
...
{
  $Log: posix.pp,v $
  Revision 1.1.2.2  2001/12/20 03:04:15  carl
  * S_ISFIFO evaaluation was wrong

  Revision 1.1.2.1  2001/12/09 03:25:17  carl
  + reinstated

  Revision 1.1.2.2  2001/12/08 03:37:40  carl
  * errno must be reset to zero after the call

  Revision 1.1.2.1  2001/12/04 02:48:17  carl
  + solaris posix unit

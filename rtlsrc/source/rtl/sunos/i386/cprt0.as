...
# the initial frame pointer.
	...
	movl	%edx,U_SYSTEM_ENVP              /* environment pointer */
	pushl   %edx                            /* push parameter for _fpstart */
	leal	12(%ebp),%edx
	movl	%edx,U_SYSTEM_ARGV             /* argument vector */
	pushl   %edx                            /* push parameter for _fpstart */
	movl	%eax,U_SYSTEM_ARGC             /* argument count */
	pushl   %eax                            /* push parameter for _fpstart */
...
#       call exit with 0 as return parameter.
#
        xorl    %eax, %eax
	pushl	%eax
	call	exit

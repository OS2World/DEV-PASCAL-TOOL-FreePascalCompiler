{
    $Id: system.pp,v 1.1.2.5 2002/03/02 20:37:58 carl Exp $
...
{
 $Log: system.pp,v $
 Revision 1.1.2.5  2002/03/02 20:37:58  carl
 - removed some stupid debug code

 Revision 1.1.2.4  2002/02/23 14:51:11  carl
 * paramstr(0) fix (now does fsearch() on $PATH)

 Revision 1.1.2.3  2001/12/09 03:25:17  carl
 + reinstated
